...
public class MetalHUD
{
    ...
    public void onRenderOverlay(RenderGameOverlayEvent.Post event)
    {
        ...
        wr.pos(centerX, centerY, 0)
          .color(1, 1, 1, 0.3f)
          .endVertex();
        for (int i = 100; i >= 0; i--)
        {
            double angle = PI * 2 * i / 100;
            wr.pos(centerX + cos(angle) * 60, centerY + sin(angle) * 60, 0)
              .color(1, 1, 1, 0.3f)
              .endVertex();
        }
        tess.draw();
        ...
        wr.pos(centerX + cos(0) * 60, centerY + sin(0) * 60, 0)
          .color(1, 1, 1, 0.3f)
          .endVertex();
        for (int i = -1; i <= 99; i++)
        {
            ...
            wr.pos(centerX + cos(angle1) * 60, centerY + sin(angle1) * 60, 0)
              .color(1, 1, 1, 0.3f)
              .endVertex();
            wr.pos(centerX + cos(angle0) * 90, centerY + sin(angle0) * 90, 0)
              .color(1, 1, 1, 0f)
              .endVertex();
        }
        tess.draw();
        ...
        for (int i = 0; i < METALS.length / 2; i++)
        {
            ...
            rect(
                centerX + (int) (cos(angle) * 40) - 8,
                centerY - (int) (sin(angle) * 40) - 8, 0, 0, 1, 1, 16, 16);
            ...
            rect(centerX + (int) (cos(angle) * 75) - 8,
                 centerY - (int) (sin(angle) * 75) - 8, 0, 0, 1, 1, 16, 16);
        }
