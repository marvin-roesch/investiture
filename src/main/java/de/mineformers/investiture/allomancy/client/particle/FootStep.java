...
public class FootStep extends EntityFX
{
    ...
    public FootStep(World world, Vec3 position, float r, float g, float b)
    {
    ...
    @Override
    public void renderParticle(WorldRenderer renderer, Entity entity, float partialTicks,
                               float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ)
    {
        ...
        disableLighting();
        Vec3 pos = Rendering.interpolatedPosition(Minecraft.getMinecraft().getRenderViewEntity(), partialTicks);
    ...
    {
        super.onUpdate();
        if (worldObj.isAirBlock(getPosition().down()))
            setDead();
    }
