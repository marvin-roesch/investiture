 ...
 */
public class AllomanticMetalBead extends AllomanticMetalItem.Abstract
{
    public static final String[] NAMES = {
        "bronze", "brass", "copper", "zinc", "tin", "pewter", "steel", "iron", "lead", "nickel", "silver", "bismuth", "cadmium", "gold",
